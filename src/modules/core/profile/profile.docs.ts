...
import { ProfileResponseFull, ProfileResponseShort } from ".";
import { CreateFullSchema } from "./dtos/profile-create.dto";
...
export const ProfileDocs: EndpointDetails[] = [
  ...
  },
  {
    ...
    response: {
      ...
      data: z.object({
        users: z.array(ProfileResponseShort),
      }),
    },
  },
  {
  ...
  },
  {
    ...
    response: {
      ...
      data: z.object({
        followers: z.array(ProfileResponseShort),
      }),
    },
  },
  {
